...
const SkillsIsotope = () => {
  ...
  const skillsData = {
    ...
    frontend: [
      { name: "HTML", proficiency: 95, desc: "Expert in semantic HTML5 markup with focus on accessibility standards and SEO-friendly structure. Experienced with custom data attributes and modern structural elements."
      },
      { name: "CSS", proficiency: 95, desc: "Strong command of CSS3 with expertise in responsive design, animations, and advanced layout techniques including Grid and Flexbox. Well-versed in cross-browser compatibility solutions."
      },
      { name: "JavaScript", proficiency: 90, desc: "Advanced JavaScript skills including ES6+ features, asynchronous programming with Promises/async-await, and DOM manipulation. Comfortable with functional programming concepts."
      },
      { name: "React", proficiency: 92, desc: "Proficient in React component architecture, hooks, context API, and performance optimization. Experienced with custom hooks and integration with various state management solutions."
      },
      { name: "Next.js", proficiency: 95, desc: "Skilled in server-side rendering, static site generation, and API routes in Next.js. Experienced with image optimization, incremental static regeneration, and middleware implementations."
      },
      { name: "Redux", proficiency: 80, desc: "Competent with Redux ecosystem including thunks, selectors, and the toolkit. Experienced in state normalization and optimization patterns for complex application state."
      },
      { name: "Tailwind", proficiency: 90, desc: "Expert in utility-first CSS with Tailwind, including custom configuration, responsive designs, and component extraction. Skilled at creating consistent design systems with minimal CSS."
      },
      { name: "SCSS", proficiency: 85, desc: "Advanced knowledge of SCSS with expertise in mixins, functions, and modular architecture. Proficient in creating maintainable stylesheets with variables and nested rules."
      },
      { name: "jQuery", proficiency: 78, desc: "Solid foundation in jQuery for DOM manipulation, animations, and AJAX operations. Experienced in legacy codebase maintenance and optimization of jQuery implementations."
      }
    ],
    others: [
      { 
  ...
  const renderSkillColumns = (skills, category) => {
    ...
    return columns.map((columnSkills, colIndex) => (
      <div key={`${category}-col-${colIndex}`} className={`skills-col col-xs-12 col-sm-6 col-md-4 col-lg-4 sorting-${category}`}>
      ...
      <div className="container">
        <div className="skills-box">
          ...
          >
            ...
            <a
              className={`c-pointer lui-subtitle ${activeBtn("sorting-automation")}`}
            ...
            <a
              className={`c-pointer lui-subtitle ${activeBtn("sorting-frontend")}`}
            ...
            <a
              className={`c-pointer lui-subtitle ${activeBtn("sorting-others")}`}
